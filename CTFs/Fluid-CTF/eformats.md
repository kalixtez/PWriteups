...
There's a much, much simpler solution as I mentioned, skipping the last part where I write `local_18`. Try to solve the exercise by yourself, and find out what it is! You'll facepalm as hard as I did... 
